...
class MainAdapter(var photos:List<Photo>,
    ...
    override fun onBindViewHolder(holder: PhotoViewHolder?, position: Int) {
        ...
        holder?.likes?.text=photo.tags.toString()
        holder?.favorites?.text=photo.tags.toString()
    ...
    inner class PhotoViewHolder(itemView:View) :RecyclerView.ViewHolder(itemView){
        ...
        init {
            ...
            itemView.tag = this
            tags=itemView.tags as TextView
            likes=itemView.likes as TextView
            favorites=itemView.favorites as TextView
            photo_item=itemView.photo_item as ImageView
